...
//config for binshops/laravel-blog
...
return [
    ...
    'include_default_routes' => true, // set to false to not include routes.php for BinshopsBlogReaderController and admin related routes. Default: true. If you disable this, you will have to manually copy over the data from routes.php and add it to your web.php.
    ...
    'image_sizes' => [
        ...
        // They must be in the same format as the default ones - image_xxxxx (and this db column must exist on the binshops_blog_posts table)
        ...
        */
        ...
        //  php artisan make:migration --table=binshops_blog_posts AddCustomBlogImageSize
